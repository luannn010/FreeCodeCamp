...
def middle_lines(transactions, max_length):
    ...
    for transaction in transactions:
        ...
        amount_str = amount[:10].rjust(10)  # Right-align amount to 10 characters
        description_str = description[:20].ljust(20)  # Left-align description to 20 characters
        trimmed_values = description_str + amount_str  # Combine description and amount strings
        result.append(trimmed_values.center(max_length))  # Center-align the combined string
    return "\n".join(result)
